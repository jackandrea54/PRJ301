            ...
            <div class="shop_inner_inf">
                ...
                <div class="col-md-8 single-right-left simpleCart_shelfItem">
                    ...
                    <div class="occasional">
                        <h5>Instock : <label class="radio" style="display: inline"><%=rs.getInt("quantity")%></label></h5>
                    </div>
                    <div class="occasional">
                        <h5>Category :</h5>
                        <div class="colr ert">  
                        ...
                        <h5>Description :</h5>
                        <div class="colr ert">
                            <label class="radio"><%=rs.getString("description")%></label>
                        </div>
                    </div>
                    <div class="occasion-cart" style="margin-top: 5em;">
                        <div class="shoe single-item single_page_b">
                            <div class="color-quality-right">
                                <h5>Quantity :</h5>
                                <input type="number" name="quantity" id="quantity" min="1" max="<%=rs.getInt("quantity")%>" required>
                            </div>
