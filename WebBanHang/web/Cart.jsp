    ...
    <body>
        ...
        <section class="header text-center">
            <nav class="navbar navbar-expand-lg navbar-light navbar-custom">
                <div class="container">
                    <!-- brand -->
                    <a class="navbar-brand" href="Home"><i class="fas fa-shopping-bag primary-color mr-1"></i> Aurum</a>
                    <!-- /brand -->
                    <!-- responsive navbar -->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <c:if test="${cartItems.size()!=0}">
                        <div class="col-sm-6 text-md-right"><a href="CheckOut" class="btn btn-primary btn-lg pl-5 pr-5">Checkout</a></div>
                    </c:if>
                </div>
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <br><br>
<!--                        <p class="mb-5"><span class="primary-color">${cartItems.size()}</span> Items in your cart</p>-->
                        <c:if test="${cartItems.size()!=0}">
                                            ...
                                            <td class="actions" data-th="">
                                                <div class="text-right">
                                                    ...
                                                    <form action="DeleteCartItem" method="post">
                                                        <input type="text" name="accountId" value="${cart.accountId}" style="display: none;">
                                                        <input type="text" name="itemId" value="${item.value.productId}" style="display: none;">
                                                        <button class="btn btn-white btn-md mb-2"><i class="fas fa-trash"><input type="submit"></i></button>
                                                    </form>
                                                </div>
                                            </td>
                                        </tr>
                        ...
                        <c:if test="${cartItems.size()==0}">
                            <h2 class="mt-5 mb-2">No item in cart </h2>
                            <br><br><br><br><br>
                        </c:if>
