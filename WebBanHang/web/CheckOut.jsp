<%-- 
    Document   : Cart
    Created on : Mar 6, 2023, 3:09:41 AM
    Author     : LENOVO
--%>
<%@page import="DAL.DAO" %>
...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <h2 class="mt-5 mb-2">Checkout</h2>
                        <br><br>
        ...
        <section>
            ...
            <div class="container">
                <form class="contact-form" action="CheckOut" method="post">
                    <div class="row contact-details">
                        ...
                        <div class="col-sm-8 text-center text-md-left">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control mb-4" id="fullname" name="fullname" placeholder="FullName" value="${account.fullname}" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="email">Email</label>
                                    <input type="email" class="form-control mb-4" id="email" name="email" placeholder="Email Address" value="${account.email}" required>
                                </div>
                                <br />
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="tel"  class="form-control mb-4" id="phoneNumber" name="phoneNumber" placeholder="Phone Number: 123-45-678" value="${account.phone_number}" required>
                                </div>
                                <div class="col-md-8">
                                                            <label for="address">Address</label>
                                    <input type="text" class="form-control mb-4" id="address" name="address" placeholder="Address" value="" required>
                                </div>
                                <br />
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control mb-4" rows="5" style="height: 10em!important; resize: none;" id="note" name="note" placeholder="Note" ></textarea>
                        ...
                        <div class="col-sm-12 text-center text-md-left">
                            <button type="submit" class="btn btn-outline-primary btn-lg mb-4">Purchase</button>
                        </div>
                    </div>
                </form>
