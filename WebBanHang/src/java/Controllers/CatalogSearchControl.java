 ...
 * @author LENOVO
 */
@WebServlet(name = "CatalogSearchControl", urlPatterns = {"/CatalogSearch"})
public class CatalogSearchControl extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("searchbar", textSearch);
        //check if user use search
        if (textSearch != null) {
            d.searchProductByName(textSearch.trim());
